...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="exCollapsingNavbar">
					...
					<ul class="nav navbar-nav flex-row justify-content-between ml-auto">
						<li><a class="navbar-menu-item" href="profile.php"><span class="glyphicon glyphicon-user"></span>
						<?php
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<button class="tablinks" onclick="openMenu(event, 'Suggestions')" id="defaultOpen">Suggestions</button>
				<button class="tablinks" onclick="openMenu(event, 'Messages')">Messages</button>
				<button class="tablinks" onclick="openMenu(event, 'Courses')">Courses</button>
				<button class="tablinks" onclick="openMenu(event, 'Findtutor')">Find Tutor or Class</button>
				<button class="tablinks" onclick="openMenu(event, 'Account')">Account</button>
			</div>

			<div id="Suggestions" class="tabcontent col-md-8 animate">
			...
			<div id="Messages" class="tabcontent col-md-8 animate">
				<div class="profile-head">
			...
			<div id="Courses" class="tabcontent col-md-8 animate">
				<div class="profile-head">
					<h2 align="center">Courses you want to learn</h2>
				</div>
			...
			<div id="Findtutor" class="tabcontent col-md-8 animate">
				<div class="profile-head">
					<h2 align="center">Find Tutor or Institute</h2>
				</div><br>
					<div align="center">
						<input type="text" placeholder="Search..." class="nsb2">
						<span style="display: inline-block; width: 10px;"></span><br><br>
