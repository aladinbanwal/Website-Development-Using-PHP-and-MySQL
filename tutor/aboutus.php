...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<button class="tablinks" onclick="openMenu(event, 'About')"
					id="defaultOpen">About Us</button>
				<button class="tablinks" onclick="openMenu(event, 'Vision')">Our
					Vision</button>
				<button class="tablinks" onclick="openMenu(event, 'Goal')">Our Goal</button>
				<button class="tablinks" onclick="openMenu(event, 'More')">More..</button>
			</div>
			<div id="About" class="tabcontent col-md-8 animate">
				<h2>About Us</h2>
				<hr>
				<p>We are a place where students, trainers and institutes come
					together and share their needs.</p>
			</div>
			<div id="Vision" class="tabcontent col-md-8 animate">
				<h2>Our Vision</h2>
				<hr>
				<p>Our Vision is..</p>
			</div>
			<div id="Goal" class="tabcontent col-md-8 animate">
				<h2>Our Goal</h2>
				<hr>
				<p>Our Goal is..</p>
			</div>
			<div id="More" class="tabcontent col-md-8 animate">
				<h2>More about us</h2>
				<hr>
				<p>More..</p>
			</div>
