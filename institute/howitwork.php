...
<html lang="en">
<head>
<title>Acute - How it works?</title>
<!-- Required meta tags -->
<meta charset="utf-8">
<meta name="viewport"
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="exCollapsingNavbar">
					...
					<ul class="nav navbar-nav flex-row justify-content-between ml-auto">
						<li><b class="tallfree">Call Us: 1800-100-0000</b></li>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 animate">
				<h2>Step 1: Search your requirements</h2>
				<p>Search about what you want to learn or what you teach.</p>
			</div>
			<div class="col-md-4 animate">
				<img
					src="https://www.oclc.org/content/dam/oclc/worldcat-org/images/discovery-icon.png"
					alt="img1" height="180" width="200">
			</div>
			<hr width="100%">
			<div class="col-md-4 animate">
				<img
					src="http://www.homestarproject.co.nz/wp-content/uploads/2016/03/Checklist.png"
					alt="img2" height="200" width="200">
			</div>
			<div class="col-md-8 animate">
				<h2>Step 2: Post your requirements</h2>
				<p>Post your learning things requirements and people will contact
					you.</p>
			</div>
			<hr width="100%">
			<div class="col-md-8 animate">
				<h2>Step 3: Contact to students</h2>
				<p>Contact to person which is matched with your requirements.</p>
			</div>
			<div class="col-md-4 animate">
				<img
					src="http://bcvacationgetaway.com/wp-content/uploads/2015/03/contact-transparent.png"
					alt="img3" height="180" width="220">
			</div>
			<hr width="100%">
			<div class="col-md-4 animate">
				<img src="http://www.ailogica.com/media/1019/demo.png" alt="img3"
					height="150" width="300">
			</div>
			<div class="col-md-8 animate">
				<h2>Step 4: Arrange a Demo Class for them</h2>
				<p>Arrange a short Demo class for students and trainers.</p>
			</div>
			<hr width="100%">
		</div>
	</div>
